package com.training.java.firstStage.cleancode;
...
public class SortingPlanes {
    ...
    public SortingPlanes(List<? extends Plane> planes) {
        this.planes = planes;
    }
}